 ...
 * Los 18 temas originales quedan comentados abajo por si se reactiva el selector.
 */
export const THEMES = [
    { id: 'light-lime', label: 'Lime', mode: 'light', preview: ['#84a70a', '#eaf5c9', '#fbfdf5'] },
    { id: 'dark-lime',  label: 'Lime', mode: 'dark',  preview: ['#c4e838', '#141a08', '#1c2410'] },

    // ── MODO CLARO (deshabilitados) ──────────────────────────
