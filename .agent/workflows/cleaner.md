---
description: encargo de limpiar y refactorizar el codigo.
---
...
1. Agente Programador → escribe el código inicial
2. Agente Limpieza → revisa y refactoriza
3. Agente Ciberseguridad → analiza vulnerabilidades
4. Agente UX/UI → valida interfaces (cuando aplique)

COORDINACIÓN ENTRE AGENTES:
- El agente de limpieza debe trabajar en conjunto con el programador
- El agente de seguridad debe tener prioridad final en temas de vulnerabilidades
- El agente UX/UI debe consultar con el programador sobre viabilidad técnica

CONFIGURACIÓN RECOMENDADA:
- Define un estilo de código compartido (ESLint, Prettier)
- Establece un sistema de severidad para issues detectados
- Crea templates de respuesta para consistencia

NIVELES DE SEVERIDAD SUGERIDOS:
🔴 CRÍTICO: Bloquea el deployment, requiere corrección inmediata
🟠 ALTO: Debe corregirse antes de merge
🟡 MEDIO: Debería corregirse en próxima iteración
🟢 BAJO: Mejora sugerida, opcional